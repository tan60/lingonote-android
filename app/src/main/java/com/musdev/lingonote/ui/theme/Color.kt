...
val LightOnPrimaryColor = Color(0xFF000000)
val LightSecondaryColor = Color(0xFFFF9A7A)
...
val LightTertiaryColor = Color(0xFFDDDDDD)
val LightOnTertiaryColor = Color(0x88FFFFFF)
val LightDisableColor = Color(0x11000000)

val DarkPrimaryColor = Color(0xFF424242)
val DarkOnPrimaryColor = Color(0xFFFFFFFF)
val DarkSecondaryColor = Color(0xFFFF9A7A)
...
val DarkTertiaryColor = Color(0xFF333333)
val DarkOnTertiaryColor = Color(0x88FFFFFF)
val DarkDisableColor = Color(0x33FFFFFF)
